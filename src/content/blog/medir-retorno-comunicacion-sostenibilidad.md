...
tags: ["retorno de la comunicación", "medición", "sostenibilidad", "comunicación estratégica"]
---
...
<aside class="callout"><span class="callout-label">EN CORTO</span> Elige dos o tres indicadores ligados a lo que la organización quiere conseguir de verdad, antes de empezar. Si nunca te dan una mala noticia, no estás midiendo.</aside>
...
Una forma práctica de hacerlo es construir una cadena corta de tres eslabones: qué quiere conseguir la organización, qué tiene que pasar en las personas para que eso ocurra, y qué hace la comunicación para provocarlo. Si no consigues unir los tres con una línea recta, probablemente estás comunicando por inercia. Lo explico con más detalle en [la importancia de la comunicación de calidad en la sostenibilidad empresarial](/blog/la-importancia-de-la-comunicacion-de-calidad-en-la-sostenibilidad-empresarial/), porque la calidad del mensaje y la posibilidad de medirlo van de la mano.
...
La primera es el [análisis de tono a lo largo del tiempo](https://amecorg.com). Una sola foto no dice nada; la evolución sí. Si las menciones críticas bajan y las de confianza suben a lo largo de un año, algo estás haciendo bien.
